...
- Option to use LOGARITHMIC thresholds
"""
...
def main():
    ...
    # ------------------------------------------------------------
    # Delete ~/Downloads/Figure_1.png BEFORE doing anything else
    # ------------------------------------------------------------
    ...
    # ------------------------------------------------------------
    # Slider rebuild when toggling log scale
    # ------------------------------------------------------------
    def rebuild_sliders():
    ...
    # ------------------------------------------------------------
    # Exit handling: window close, Ctrl+C
    # ------------------------------------------------------------
    def handle_exit(*_):
        save_full_res_masks()
        sys.exit(0)
    ...
    print("  - Checkboxes: invert depth, log mode")
    print("  - Press 's' to save masks manually")
    print("  - Closing the window or Cmd+C auto-saves")
    print("  - ~/Downloads/Figure_1.png deleted on startup")
